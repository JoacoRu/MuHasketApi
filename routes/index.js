...
//Usuarios
routes.get('/users/:userId/:pass', usersController.get.bind(usersController));
...
//Personajes
routes.get('/charactersByAccount/:userId', characterControllerClass.listAccount.bind(characterControllerClass));
